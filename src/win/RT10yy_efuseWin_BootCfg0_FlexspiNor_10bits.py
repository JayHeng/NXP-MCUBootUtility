...
###########################################################################
## Class efuseWin_BootCfg0_FlexspiNor_10bits
###########################################################################

class efuseWin_BootCfg0_FlexspiNor_10bits ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText_bit3_1 = wx.StaticText( self, wx.ID_ANY, u"Flash_Type", wx.DefaultPosition, wx.Size( 260,-1 ), wx.ALIGN_CENTER_HORIZONTAL|wx.BORDER_SIMPLE )
		...
		m_choice_bit3_1Choices = [ u"000 - Device supports 3B read by default", u"001 - Device supports 4B read by default", u"010 - HyperFlash 1V8", u"011 - HyperFlash 3V3", u"100 - MXIC Octal DDR", u"101 - Micron Octal DDR", u"110 - Reserved", u"111 - QSPI supports 3B read (on 2nd pinmux option)" ]
		...
		self.m_staticText_bit9_8 = wx.StaticText( self, wx.ID_ANY, u"Hold_Time", wx.DefaultPosition, wx.Size( 170,-1 ), wx.ALIGN_CENTER_HORIZONTAL|wx.BORDER_SIMPLE )
		...
		m_choice_bit9_8Choices = [ u"00 - 500us", u"01 - 1ms", u"10 - 3ms", u"11 - 10ms" ]
